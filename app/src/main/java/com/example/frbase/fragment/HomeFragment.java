...
import com.example.frbase.LoginActivity;
import com.example.frbase.R;
import com.example.frbase.SetName;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signOutButton=view.findViewById(R.id.signOutId);
        circleImageView=view.findViewById(R.id.circleImageId);
        nameText=view.findViewById(R.id.userNameId);
        emailText=view.findViewById(R.id.userEmailId);
        editNameText=view.findViewById(R.id.editUserNameId);
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        image_path.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                mRef.child(firebaseAuth.getCurrentUser().getUid()).child("Image")
    ...
    private void editName() {
        ...
        final View view=inflater.inflate(R.layout.editname,null);
        builder.setView(view).setTitle("Edit User Name").setCancelable(true).setNegativeButton("Close", new DialogInterface.OnClickListener() {
            @Override
        ...
        editProgress= view.findViewById(R.id.progressBar2Id);
                    ...
                    mRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(checkUserName(newName,snapshot)){
                                ...
                                mRef.child(currentUser).child("name").setValue(newName).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            editProgress.setVisibility(View.GONE);
    ...
    private void setProfile() {
        ...
        mRef.child(currentUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(getActivity()).load(image).centerCrop().placeholder(R.drawable.twhd).into(circleImageView);
